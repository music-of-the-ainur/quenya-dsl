...
```
libraryDependencies += "com.github.music-of-the-ainur" %% "quenya-dsl" % "1.2.1-$SPARK_VERSION"
```

To run in spark-shell:

```
spark-shell --packages "com.github.music-of-the-ainur:quenya-dsl_2.13:1.2.1-$SPARK_VERSION"
```
